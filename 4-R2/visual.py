...
class Visualization:
    ...
    def ppl(self, t_ppl, v_ppl):
        ...
        t = plt.plot(x_1, t_ppl, label=u'ppl value', linestyle=':', marker='+', color='green', alpha=0.75)
        v = plt.plot(x_2, v_ppl, label=u'ppl value', linestyle=':', marker='x', color='red', alpha=0.75)
    ...
    def acc(self, t_acc, v_acc):
        ...
        t = plt.plot(x_1, t_acc, label=u'train acc', linestyle=':', marker='+', color='green', alpha=0.75)
        v = plt.plot(x_2, v_acc, label=u'val acc', linestyle=':', marker='x', color='red', alpha=0.75)
